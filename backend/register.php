        ...
        <div class="card-content p-2">
          ...
          <form method="post">
            ...
            <div class="form-group">
              ...
              <div class="position-relative has-icon-right">
                <input type="text" name="email" id="exampleInputEmailId" class="form-control input-shadow" placeholder="Enter Your Email ID">
                <div class="form-control-position">
            ...
            <div class="form-group">
              ...
              <div class="position-relative has-icon-right">
                <input type="text" name="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Choose Password">
                <div class="form-control-position">
                  <i class="icon-lock"></i>
                </div>
              </div>
